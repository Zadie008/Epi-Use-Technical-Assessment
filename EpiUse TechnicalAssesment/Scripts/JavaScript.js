document.addEventListener("DOMContentLoaded", function () {
    PageMethods.GetHierarchyData(function (data) {
        buildHierarchy(data);
    });
});
...
function renderD3(rootData) {
    ...
    // different styles for the interns
    node.append("circle")
        .attr("r", 25)
        .attr("class", d => {
            const baseClass = "ranking" + d.data.Ranking;
            return d.data.PositionID === 6 ? baseClass + " intern" : baseClass;
        });
